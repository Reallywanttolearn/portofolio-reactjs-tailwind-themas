            ...
            <section id="about">
                <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Hallo, I'm Themas
                                        <br className="hidden lg:inline-block" />I love to build amazing apps. </h1>
                        <p className="mb-8 leading-relaxed">Web ini di buat untuk mendokumentasikan semua skill dan projek yang sudah saya kuasai atau kerjakan</p>
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        <img src={logoreact} className="object-cover object-center rounded" alt="hero"/>
                    </div>
                </div>
